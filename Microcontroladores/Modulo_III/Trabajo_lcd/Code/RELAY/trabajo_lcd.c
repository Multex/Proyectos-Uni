...
#bit F3 = portb.2
#bit F4 = portb.3
#bit MT = porta.0 // Puerto para el motor
/*******************/
...
//!    for(int A=0; A < 5; A++){ // Detectar el numero de pasos
//!        portc = motorSteps[A];
//!        delay_ms(80);
//!    }
//! }

//! void motorControl(){ //* Usado para controlar el motor | Funcion para usar L293D, no se usa
//!     porta = 0b00000010; // Manda senal a A6
//!     delay_ms(80);
//!     porta = 0b00000001; // Manda senal a A7
//!     delay_ms(80);
//! }

void main(){
    //! port_b_pullups(true); Activa resistencias internas | No funciona
    trisa = 0b00000000;
    trisb = 0b00001111;
